...
myScratchpads = do
  ...
  telegramSP <- getInput $ inEditor >-> setFrameName telegramID >-> eval (elispFun "telega")
...
addKeys conf@XConfig{modMask = modm} =
  ...
  buildDirectionalBindings modm myWindowGo
    ...
    ++ [ ((modm, xK_g), myGoToWindow)
       ...
       , ((modalt, xK_l), spawn "betterlockscreen -l dim")
