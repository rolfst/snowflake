...
in {
  ...
  config = mkIf cfg.epiphany.enable (mkMerge [
    ...
    (mkIf isDefault {
      home.sessionVariables.BROWSER = "epiphany";
      modules.desktop.extensions.mimeApps.defApps.webBrowser = "epiphany.desktop";
    })
  ]);
}
